...
\documentclass[9pt,a4paper,ragged2e,withhyper,normalphoto]{altacv}
...
\definecolor{CisariaRed}{RGB}{115, 40, 60}
\definecolor{CisariaGreen}{RGB}{0, 128, 9}
\colorlet{name}{black}
\colorlet{tagline}{PastelRed}
\colorlet{heading}{PastelRed}
\colorlet{headingrule}{CisariaGreen}
...
\cvevent{Bioinformatician}{University of Gothenburg}{Sep 2024 -- present}{Gothenburg, Sweden}
Responsibilities:
\begin{itemize}
...
\cvevent{Assistant with Doctoral Duties}{Uppsala University\\ Department of Immunology, Genetics and Pathology}{Mar 2024 -- Sep 2024}{Uppsala, Sweden}
\begin{itemize}
...
\cvevent{Volunteer}{RFSL Göteborg}{Sep 2024 -- present}{Gothenburg, Sweden}
\begin{itemize}
...
\cvevent{Secretary}{Medical PhD Student Board (Medicinska Doktorandrådet, MDR)}{Jul 2021 -- Jun 2023}{Uppsala, Sweden}
\begin{itemize}
...
\cvevent{Representative to MDR}{IGP PhD Student Council}{Sep 2019 -- Jun 2023}{Uppsala, Sweden}
\divider

\cvevent{Treasurer}{Medical PhD Student Board}{Jul 2021 -- Jun 2022}{Uppsala, Sweden}
\divider

\cvevent{Representative to Uppsala University's PhD Board}{Medical PhD Student Board}{Sep 2019 -- Jun 2022}{Uppsala, Sweden}
\divider

\cvevent{Head of Election Committee}{Uppsala University's PhD Student Board (Doktorandnämnden)}{Apr 2020 -- Jun 2020}{Uppsala, Sweden}
\divider

\cvevent{Head of Membership Administration}{Verein für Corpsstudentische Geschichtsforschung e.V.}{Jun 2017 -- Jul 2019}{Munich, Germany}
...
\cvevent{Abitur}{Friedrich-Schiller-Gymnasium Königs Wusterhausen}{Aug 2005 -- Jun 2013}{}
Grade: 1.0

\cvsection{Awards}
\cvevent{best.in.tum}{Technical University of Munich}{Oct 2018}{}
Awarded to the top 2\% of graduates at the TUM School of Computation, Information and Technology
...
\vspace{12pt}
%\includegraphics*[height=60pt]{signature.png}
\end{document}
