...
\cvachievement{\faDatabase}{SweGen T2T-CHM13 Release}{Reanalysis of WGS data from 1,000 individuals using the novel reference T2T-CHM13}

\divider

\cvachievement{\faUsers}{Uppsala Pride 2022}{First pride festival after the COVID-19 pandemic (>3,000 participants)}

\divider

\cvachievement{\faComments}{Queer Regina}{Collaboration bringing local LGBTQ+ art to the theater stage}
...
\cvevent{B.Sc.\ in Bioinformatics}{Ludwig-Maximilians-Universität,\\Technical University of Munich}{Oct 2013 -- Sep 2017}{}
