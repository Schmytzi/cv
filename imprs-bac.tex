...
\photo[70pt][0pt]{pictures/PP-Schmitz-741-druck-color-resized.jpg} % TPP-PP-Schmitz-692-druck-color.jpghe first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\clearpage
\vspace*{-2cm}
\recipient{IMPRS for Biology and Computation}
{Max-Planck-Institut für molekulare Genetik\\
Ihnestr. 63--73\\
14195 Berlin} % Letter recipient
...
During my work in diagnostics I gained interest in molecular genetics.
...
\cventry{since 2017}{M.Sc. Bioinformatics}{Ludwig-Maximilians-Universität and Technical University of Munich}{}{Graduation in early 2019}{}  % Arguments not required can be left empty
...
\cvdoubleitem{\textbf{Spanish}}{Intermediate}{\textbf{French}}{Basic}
...
\cvdoubleitem{}{\textbf{Prof. Dr. Volker Heun}\\
	...
	Amalienstr. 17\\
	80333 München}{}{\textbf{Dr. Sebastian Eck}\\
	Center for Human Genetics and Laboratory Diagnostics\\
	Lochhamer Str. 29\\
	82152 Martinsried}
\vspace{6pt}
\cvitemwithcomment{}{\normalfont\textbf{Hayim Malkhasy}\\
Leiter des Büros der Chemisch-Physikalisch-Technischen Sektion\\
